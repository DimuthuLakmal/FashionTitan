...
public class DBConnection {
    ...
    public JSONArray getUser(String un,String pw){
        ...
        String url="http://localhost/Fashion/userlogin.php?un="+un+"&pw="+pw+"&functionname=selectuser";
    ...
    public JSONObject getUserDetail(String un, String pw){
        String url="http://10.0.2.2/Fashion/userlogin.php?un="+un+"&pw="+pw+"&functionname=selectuser";
